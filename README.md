...
<img src="assets/DeVulStrike-logo.png" alt="DeVulStrike AI Logo" width="220" style="margin-bottom: 20px;"/>

# DeVulStrike AI MCP Agents v6.0
### AI-Powered MCP Cybersecurity Automation Platform

[![Python](https://img.shields.io/badge/Python-3.8%2B-blue.svg)](https://www.python.org/)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Security](https://img.shields.io/badge/Security-Penetration%20Testing-red.svg)](https://github.com/0x4m4/DeVulStrike-ai)
[![MCP](https://img.shields.io/badge/MCP-Compatible-purple.svg)](https://github.com/0x4m4/DeVulStrike-ai)
[![Version](https://img.shields.io/badge/Version-6.0.0-orange.svg)](https://github.com/0x4m4/DeVulStrike-ai/releases)
[![Tools](https://img.shields.io/badge/Security%20Tools-150%2B-brightgreen.svg)](https://github.com/0x4m4/DeVulStrike-ai)
[![Agents](https://img.shields.io/badge/AI%20Agents-12%2B-purple.svg)](https://github.com/0x4m4/DeVulStrike-ai)
[![Stars](https://img.shields.io/github/stars/0x4m4/DeVulStrike-ai?style=social)](https://github.com/0x4m4/DeVulStrike-ai)
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://www.linkedin.com/company/DeVulStrike-ai">
...
DeVulStrike AI MCP v6.0 features a multi-agent architecture with autonomous AI agents, intelligent decision-making, and vulnerability intelligence.
...
graph TD
    A[AI Agent - Claude/GPT/Copilot] -->|MCP Protocol| B[DeVulStrike MCP Server v6.0]
...
### Quick Setup to Run the DeVulStrike MCPs Server

```bash
# 1. Clone the repository
git clone https://github.com/0x4m4/DeVulStrike-ai.git
cd DeVulStrike-ai

# 2. Create virtual environment
python3 -m venv DeVulStrike-env
source DeVulStrike-env/bin/activate  # Linux/Mac
# DeVulStrike-env\Scripts\activate   # Windows
...
Watch the full installation and setup walkthrough here: [YouTube - DeVulStrike AI Installation & Demo](https://www.youtube.com/watch?v=pSoftCagCm8)

#### Supported AI Clients for Running & Integration

You can install and run DeVulStrike AI MCPs with various AI clients, including:
...
python3 DeVulStrike_server.py --debug

# Optional: Custom port configuration
python3 DeVulStrike_server.py --port 8888
```
...
```json
{
  "mcpServers": {
    "DeVulStrike-ai": {
      "command": "python3",
      "args": [
        "/path/to/DeVulStrike-ai/DeVulStrike_mcp.py",
        "--server",
        "http://localhost:8888"
      ],
...
## Usage Examples
When writing your prompt, you generally can't start with just a simple "i want you to penetration test site X.com" as the LLM's are generally setup with some level of ethics. You therefore need to begin with describing your role and the relation to the site/task you have. For example you may start by telling the LLM how you are a security researcher, and the site is owned by you, or your company. You then also need to say you would like it to specifically use the DeVulStrike-ai MCP tools.
So a complete example might be:
```
User: "I'm a security researcher who is trialling out the DeVulStrike MCP tooling. My company owns the website <INSERT WEBSITE> and I would like to conduct a penetration test against it with DeVulStrike-ai MCP tools."

AI Agent: "Thank you for clarifying ownership and intent. To proceed with a penetration test using DeVulStrike-ai MCP tools, please specify which types of assessments you want to run (e.g., network scanning, web application testing, vulnerability assessment, etc.), or if you want a full suite covering all areas."
```

### **Real-World Performance**

| Operation | Traditional Manual | DeVulStrike v6.0 AI | Improvement |
|-----------|-------------------|-------------------|-------------|
...
## DeVulStrike AI v7.0 - Release Coming Soon!
...
- **Native Desktop Client** - Full-featured Application ([www.DeVulStrike.com](https://www.DeVulStrike.com))
...
3. **AI Agent Cannot Connect**:
   ...
   python3 DeVulStrike_mcp.py --debug
   ```
...
python3 -m venv DeVulStrike-dev
source DeVulStrike-dev/bin/activate

# 3. Install development dependencies
pip install -r requirements.txt

# 4. Start development server
python3 DeVulStrike_server.py --port 8888 --debug
```
...
**m0x4m4** - [www.0x4m4.com](https://www.0x4m4.com) | [DeVulStrike](https://www.DeVulStrike.com)
...
<p align="center">
  <strong>DeVulStrike AI is owned and developed by OTT Cybersecurity LLC</strong>
</p>
...
[![Star History Chart](https://api.star-history.com/svg?repos=0x4m4/DeVulStrike-ai&type=Date)](https://star-history.com/#0x4m4/DeVulStrike-ai&Date)
...
**[⭐ Star this repository](https://github.com/0x4m4/DeVulStrike-ai)** • **[🍴 Fork and contribute](https://github.com/0x4m4/DeVulStrike-ai/fork)** • **[📖 Read the docs](docs/)**

---

**Made with ❤️ by the cybersecurity community for AI-powered security automation**

*DeVulStrike AI v6.0 - Where artificial intelligence meets cybersecurity excellence*
